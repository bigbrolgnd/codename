  ...
  return (
    ...
    >
      <div className="w-full max-w-lg bg-zinc-900 border border-zinc-800 rounded-3xl p-8 shadow-2xl text-center relative overflow-hidden">
        {/* Background Glow */}
        <div className="absolute -top-24 -left-24 w-48 h-48 bg-pink-500/20 blur-[100px] rounded-full" />
        ...
        >
          <div className="w-20 h-20 bg-pink-500/10 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-pink-500/20">
          ...
          <div className="bg-zinc-950/50 border border-zinc-800 rounded-xl p-4 mb-8 flex items-center justify-between group cursor-pointer hover:border-zinc-700 transition-colors" onClick={onViewSite}>
            <div className="text-left overflow-hidden">
              ...
              <p className="text-pink-400 font-medium truncate">{siteUrl.replace('https://', '')}</p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Button size="lg" onClick={onViewSite} className="w-full bg-pink-600 hover:bg-pink-500 text-white shadow-lg shadow-pink-900/20 glow-soft">
              View My Site
